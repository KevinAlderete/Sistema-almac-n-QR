                ...
                <div class="mx-auto max-w-screen-lg sm:px-8">
                    <div class="flex items-center justify-between pb-6">
                      <div>
                        ...
                        <span class="text-xs text-gray-500">Escanea los productos</span>
                      </div>
                      <div class="flex items-center justify-between">
                        <div class="ml-10 space-x-8 lg:ml-40">
                          <a href="{{ route('articulos.reporte') }}" class="flex items-center gap-2 rounded-md bg-[#1958A6] px-4 py-2 text-sm font-semibold text-white focus:outline-none focus:ring hover:bg-blue-700">
                    ...
                    <div class="">
                        <div class="flex justify-center">
                            ...
                            <div class="hidden relative">
                                <form method="POST" id="formQR" action="{{ route('articulos.codeqr') }}" class="py-4 px-8 border shadow-xl rounded-b-xl">
                                    @csrf 
