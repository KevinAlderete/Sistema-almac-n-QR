                        ...
                        <div class="container mx-auto">
                          <div class="w-5/6 lg:w-1/2 mx-auto bg-white rounded shadow">
                            <div class="py-4 px-8 text-black text-xl border-b-2 border-grey-lighter"></div>
                                <form method="POST" action="{{ route('categorias.update', $categoria) }}" class="py-4 px-8 border shadow-xl rounded-b-xl">
                                  @csrf 
                                  @method('PUT') 
                                    <div class="mb-4">
                                        <label class="block text-gray-700 text-sm font-bold mb-2" for="categoria">Categoria</label>
                                        <input value="{{ $categoria->categoria }}" class="appearance-none border rounded w-full py-2 px-3 text-gray-700" id="categoria" name="categoria" type="text" placeholder="Ingrese categoria">
                                    ...
                                    <div class="mb-4">
                                      ...
                                      <input value="{{ $categoria->marca }}" class="appearance-none border rounded w-full py-2 px-3 text-gray-700" id="marca" name="marca" type="text" placeholder="Ingrese marca">
                                    ...
                                    <div class="mb-4">
                                      ...
                                      <input value="{{ $categoria->modelo }}" class="appearance-none border rounded w-full py-2 px-3 text-gray-700" id="modelo" name="modelo" type="text" placeholder="Ingrese modelo">
