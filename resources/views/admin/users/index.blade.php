            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">       
                <div class="mx-auto max-w-screen-lg sm:px-8">
                    <div class="flex items-center justify-between pb-6">
                      <div>
                        <h2 class="font-semibold text-gray-700">Usuario</h2>
                        <span class="text-xs text-gray-500">Visualiza los usuarios</span>
                      </div>
                      <div class="flex items-center justify-between">
                        <div class="ml-10 space-x-8 lg:ml-40">
                          <a href="{{ route('admin.users.create') }}" class="flex items-center gap-2 rounded-md bg-[#1958A6] px-4 py-2 text-sm font-semibold text-white focus:outline-none focus:ring hover:bg-blue-700">
                            ...
                            <tr>
                              ...
                              <td>
                                <div class="flex justify-center gap-4">
                                  <a href="{{ route('admin.users.show', $user->id) }}" class="hover:text-blue-600">Editar</a>
                                  @if ($user->id != 1)
